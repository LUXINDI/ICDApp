...
public class DetectUpdateHandler extends SimpleThreadHandler{
    ...
    public DetectUpdateHandler(Context context,TextView tv){
        this.context=context;
        this.tvNewVersion=tv;
    }
    ...
    protected void runInFrontend(String data) {
        ...
        try {
            ...
            if(compareVersion(version, cur_version)>0)
            {
                ...
                tvNewVersion.setText(context.getResources().getText(R.string.newversion));
                // tvNewVersion.setVisibility(View.VISIBLE);
                // showUpdataDialog();
                //udpate
            }else {
                ...
                //not update
                tvNewVersion.setTextColor(Color.parseColor("#009100"));
                tvNewVersion.setText(context.getResources().getText(R.string.curversion));
